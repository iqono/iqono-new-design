...
const FAQ12 = ({ questions, pageType }) => {
  ...
  const defaultQuestions = {
    product: [
      { 
        question: "testtetfsfsWhat payment methods are supported?", 
