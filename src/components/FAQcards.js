...
const FAQcards = ({ questions, pageType }) => {
  ...
  const defaultQuestions = {
    product: [
      { 
        question: "What is card acquiring?", 
        answer: "Card acquiring allows your business to accept credit and debit card payments from customers worldwide." 
      },
      { 
      ...
      { 
        question: "Do you support exotic or local currencies?", 
      ...
      { 
        question: "How do I integrate card acquiring into my website or app?", 
